...
function getTransaction() {
    ...
    xhr.open("GET", "http://127.0.0.1:3000/storage/" + transaction);
    xhr.send();
...
function updateTransaction() {
    ...
    let xhr = new XMLHttpRequest();
    if (transaction != "") {
        xhr.open("PUT", 'http://localhost:3000/storage/' + transaction, true);
    } else {
        xhr.open("POST", 'http://localhost:3000/storage', true);
    }
